...
function Invoke-SB4-Hotseat1Tests {
    ...
    $c1PrivateWritePlan = New-LinuxMountedPrivateWriteWorkflowPlan -SharePrefix 'C1' -Platform 'C1' -UserSpecs ((Get-C1Client2LinuxUserSpecs) | Where-Object { $_.Token -in @('EMPLOYEE1', 'EMPLOYEE2') })
