function Get-ServiceBlockCoverage {
    ...
    @(
        ...
        [pscustomobject]@{ Block = '4'; Hotseat = '2'; Area = 'Replicated File Server'; Coverage = 'Company 2 Gluster, Samba public/private share definitions, successful client share mounts for admin plus c2.local domain-user sessions with write-capability checks, share readability, and private-share isolation'; Mode = 'Automated' }
