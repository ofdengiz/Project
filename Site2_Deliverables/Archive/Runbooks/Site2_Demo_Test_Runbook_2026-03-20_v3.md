...
- leave the direct Site 2 Linux web server and other value-add items for the post-demo add-on section
...
"For the live service-block demo, we are focusing on the core DNS and HTTPS proof path. The direct Site 2 Linux web server will be presented later as a value-add item rather than as a main demo dependency."
