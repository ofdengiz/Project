...
**Figure 13. `C1UbuntuClient` Company 1 client dual-web evidence.**  
Description: Insert a screenshot from `C1UbuntuClient` showing the `admin@C1UbuntuClient` prompt, `c1.local` membership, and successful access to both `c1-webserver.c1.local` and `c2-webserver.c2.local`.  
