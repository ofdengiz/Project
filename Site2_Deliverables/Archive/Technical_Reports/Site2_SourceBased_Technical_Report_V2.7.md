...
| Status | Client-facing technical handover revision with March 25 operational baseline |
...
| Section | Heading |
|---|---|
| Executive Summary | Integrated findings and operating-state summary |
| 1 | Introduction |
| 2 | Background |
| 2.1 | Design inputs and environment evidence |
| 2.1.1 | Design and service expectations |
| 2.1.2 | Site 2 environment evidence |
...
| 3.2.1 | Observed Linux VM platform baseline |
| 3.2.2 | Service placement rationale |
| 3.2.3 | Technology and service-stack rationale |
| 3.2.4 | Delivery-phase configuration refinements |
| 3.3 | MSP entry, network segmentation, remote access, and security rationale |
| 3.3.1 | Interface and segment design |
| 3.3.2 | Policy and exposure model |
| 3.3.3 | Operational interpretation |
| 3.4 | Company 1 services |
| 3.4.1 | Service overview |
| 3.4.2 | Architectural rationale |
| 3.4.3 | Observed operating state |
| 3.4.4 | Service composition and operational reading |
| 3.5 | Company 2 identity, shared forest context, DNS, and DHCP |
| 3.5.1 | Identity service health |
| 3.5.2 | Namespace and forest design |
| 3.6 | Storage, file services, and isolated SAN design |
| 3.6.1 | File-service state |
| 3.6.2 | SAN isolation model |
| 3.6.3 | Share presentation model |
| 3.7 | Client access, identity validation, and dual-hostname web delivery |
| 3.7.1 | Client validation perspectives |
| 3.7.2 | Client resolver and share-consumption alignment |
| 3.7.3 | Hostname-based web publishing behavior |
| 3.7.4 | Client-service interpretation |
| 3.8 | Backup, recovery, and offsite protection |
| 3.8.1 | Backup design basis |
| 3.8.2 | Inter-site backup path |
| 3.8.3 | Current operational state |
| 3.8.4 | Recovery role in the overall site design |
...
| 4 | Conclusion |
| 5 | Appendices |
| A | Observed addressing, gateways, and endpoints |
| B | Evidence and reference traceability |
| C | Service verification matrix |
| 6 | References |
